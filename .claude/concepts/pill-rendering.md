...
- The bar-finding sweep runs only on σ-clumps of at least two platforms. Singletons, singleton tangent groups, and singleton σ-clumps within a multi-clump tangent group all flow through Candidate B's legacy algorithm alongside the bars.
