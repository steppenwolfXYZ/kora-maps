...
- This is a prerequisite for the per-variant freq work in `trip-group-rare-variant-filter.md` — once direction is no longer collapsed for these modes, the per-direction freq metric becomes consistent across all buckets.
