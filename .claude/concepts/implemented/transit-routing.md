...
Before the two cases, three unconditional prunes run on every pair where B Pareto-dominates A in time — no marginality allowance applies to any of them. (Rule 0 alone also fires on an exact time tie; see below.)
