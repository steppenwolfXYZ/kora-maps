...
Before the two cases, three unconditional prunes run on every pair where B Pareto-dominates A in time — no marginality allowance applies to any of them.
