...
// kora fork: kMaxVias raised to 3 (via-stops.md) — the print<3>
// instantiation below was added to match.
...
template void raptor_state::print<3>(timetable const&, date::sys_days, delta_t);
