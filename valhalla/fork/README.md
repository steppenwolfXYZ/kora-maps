...
| (turns) | | the flat per-turn seconds (right 3, left 4, U-turn 8 at 20 km/h) scale with the flat speed: leisurely 0.75×, fast / e-bike 1.2×, professional 1.4×, fast e-bike 1.5× — time and cost |
