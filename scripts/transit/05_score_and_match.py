...
def _lookup_canonical_stops(
    ...
    Returns (best_coords, used_name_fallback).  best_coords is empty if no canonical
    was found or if a name-fallback canonical failed the geo sanity check (Trigger 1).
